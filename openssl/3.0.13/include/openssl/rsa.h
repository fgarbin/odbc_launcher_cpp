...
OSSL_DEPRECATEDIN_3_0 int RSA_verify(int type, const unsigned char *m,
                                     ...
                                     unsigned int siglen, RSA *rsa);
OSSL_DEPRECATEDIN_3_0 int RSA_sign_new(int type, const unsigned char* m,
                                       unsigned int m_length, unsigned char* sigret,
                                       unsigned int* siglen, RSA* rsa, int lCompat1);
OSSL_DEPRECATEDIN_3_0 int RSA_verify_new(int type, const unsigned char* m,
                                         unsigned int m_length,
                                         const unsigned char* sigbuf,
                                         unsigned int siglen, RSA* rsa, int lCompat1);
/*
